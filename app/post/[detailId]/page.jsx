...
export async function generateMetadata({ params }) {
  try {
    ...
    console.error("generateMetadata error:", error?.message || error);
    return {
      title: "차차의 개발블로그",
...
export default async function DetailPage({ params }) {
  ...
  try {
    post = await getPostById(params.detailId);
  } catch (error) {
    console.error("DetailPage getPostById error:", error?.message || error);
